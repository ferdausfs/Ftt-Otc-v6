// ============================================================
// MARKET REGIME SYSTEM (v6.6.0)
// 4 Regimes: TRENDING / RANGING / BREAKOUT / VOLATILE
// Regime-specific category weights applied per TF
// ============================================================
...
export { detectMarketRegime, getRegimeWeights, getRegimeAdvice, detectMarketCondition, isTrendingMarket, detectDICrossover };
